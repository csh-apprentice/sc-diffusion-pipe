...
syn_scores = [0.352, 0.343, 0.431]
real_scores = [0.096, 0.021, 0.281]
...
ax.set_ylim(bottom=0, top=max(all_scores) * 1.2) # 0 to 20% above max
...
plt.savefig("vqa_score_bar_plot.pdf", bbox_inches='tight')

# Also save as a high-DPI PNG for quick viewing
plt.savefig("vqa_score_bar_plot.png", dpi=300, bbox_inches='tight')

# Show the plot
print("Plot saved as 'vqa_score_bar_plot.pdf' and 'vqa_score_bar_plot.png'")
plt.show()