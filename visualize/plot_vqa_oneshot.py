...
# Axes & labels
ax.set_title("Synthetic and Real VQA Score Comparison", pad=20, loc="center")
...
annotate(b2, pct=None, color="#1f3f66", y_gap_pt=3, two_lines=True)
annotate(b3, pct=None, color="#6b1e14", y_gap_pt=3, two_lines=True)
...
# ---------------- Save ----------------
fig.savefig("vqa_grouped_one.pdf", bbox_inches="tight")
fig.savefig("vqa_grouped_one.png", dpi=300, bbox_inches="tight")
print("Saved: vqa_grouped_one.pdf, vqa_grouped_one.png")
