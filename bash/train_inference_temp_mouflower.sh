...
python test_fps_batch_prompts.py \
    ...
    --checkpoint ../checkpoints/20251107_00-51-16/epoch1000 \
    --fps_values 0.0 \
    --steps 50 \
    --frames 49 \
    --output_dir ../output/50_49/20251107_00-51-16 \
    ...
    --height 512 \
    --base_only \
    > ../output/nohup_log/temp_20251107_00-51-16_49frames.out 2>&1 
