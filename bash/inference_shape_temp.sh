...
#     --config /root/workspace/sc-diffusion-pipe/checkpoints/20251021_19-21-34/wan_SC_TARGET_14B_2DSHAPE_TEMP.toml \
#     --checkpoint ../checkpoints/20251021_19-21-34/epoch1000 \
#     --fps_values 2000 6000 12000 \
#     --steps 50 \
#     --frames 49 \
#     --output_dir ../output/temp_20251021_19-21-34_epoch1000_temp \
...
#     --width 512 \
#     --height 512 \
#     > ../output/nohup_log/temp_20251021_19-21-34_epoch1000_span1.out 2>&1 
...
# echo "$(date) starting inferencing 1"
# python test_fps_multiple_experiments_align_old.py \
#     --config /root/workspace/sc-diffusion-pipe/checkpoints/20251010_06-32-51/wan_SC_TARGET_14B_SHAPE_TEMP_REDBLUEWHITE_ALL.toml \
#     --checkpoint ../checkpoints/20251010_06-32-51/epoch1000 \
#     --fps_values 3000 6000 10000  \
#     --steps 50 \
#     --frames 49 \
#     --output_dir ../output/20251010_06-32-51_epoch1000_temp_debug \
#     --prompt_folder  /root/workspace/sc-diffusion-pipe/prompt_folder/temp_prompts/span1 \
#     --negative_prompt "色调艳丽，过曝，静态，细节模糊不清，字幕，风格，作品，画作，画面，静止，整体发灰，最差质量，低质量，JPEG压缩残留，丑陋的，残缺的，多余的手指，画得不好的手部，画得不好的脸部，畸形的，毁容的，形态畸形的肢体，手指融合，静止不动的画面，杂乱的背景，三条腿，背景人很多，倒着走" \
#     --seed 42 \
#     --port 29502 \
#     --width 512 \
#     --height 512 \
#     > ../output/nohup_log/temp_20251010_06-32-51_epoch1000_debug.out 2>&1 
...
python test_fps_multiple_experiments_align_old.py \
    ...
    --steps 50 \
    --frames 49 \
    --output_dir ../output/temp_20251023_00-19-38_epoch1000_temp_fps_only \
    ...
    --height 512 \
    --fps_only \
    > ../output/nohup_log/temp_20251023_00-19-38_epoch1000_span2_only.out 2>&1 
...
python test_fps_multiple_experiments_align_old.py \
    ...
    --steps 50 \
    --frames 49 \
    --output_dir ../output/temp_20251023_00-19-38_epoch1000_temp \
    --prompt_folder  /root/workspace/sc-diffusion-pipe/prompt_folder/temp_prompts/span2 \
    --negative_prompt "色调艳丽，过曝，静态，细节模糊不清，字幕，风格，作品，画作，画面，静止，整体发灰，最差质量，低质量，JPEG压缩残留，丑陋的，残缺的，多余的手指，画得不好的手部，画得不好的脸部，畸形的，毁容的，形态畸形的肢体，手指融合，静止不动的画面，杂乱的背景，三条腿，背景人很多，倒着走" \
    --seed 42 \
    --port 29502 \
    --width 512 \
    --height 512 \
    > ../output/nohup_log/temp_20251023_00-19-38_epoch1000_span2.out 2>&1 
...
python test_fps_multiple_experiments_align_old.py \
    ...
    --height 512 \
    --fps_only \
    > ../output/nohup_log/temp_20251023_00-19-38_epoch1000_span2_debug.out 2>&1 

# echo "$(date) starting inferencing"
# cd inference
# python test_fps_multiple_experiments_align_old.py \
#     --config /root/workspace/sc-diffusion-pipe/checkpoints/20251024_18-52-42/wan_SC_TARGET_14B_TEMP_150.toml \
#     --checkpoint ../checkpoints/20251024_18-52-42/epoch500 \
#     --fps_values -1.0 0.0 1.0 \
#     --steps 50 \
#     --frames 49 \
#     --output_dir ../output/temp_20251024_18-52-42_epoch500_temp \
#     --prompt_folder  /root/workspace/sc-diffusion-pipe/prompt_folder/temp_prompts/span1\
#     --negative_prompt "色调艳丽，过曝，静态，细节模糊不清，字幕，风格，作品，画作，画面，静止，整体发灰，最差质量，低质量，JPEG压缩残留，丑陋的，残缺的，多余的手指，画得不好的手部，画得不好的脸部，畸形的，毁容的，形态畸形的肢体，手指融合，静止不动的画面，杂乱的背景，三条腿，背景人很多，倒着走" \
#     --seed 42 \
#     --port 29502 \
#     --width 512 \
#     --height 512 \
#     > ../output/nohup_log/temp_20251024_18-52-42_epoch500_span1.out 2>&1 