...
python test_fps_multiple_experiments_align.py \
    --config /root/workspace/sc-diffusion-pipe/checkpoints/20251005_20-28-40/wan_SC_TARGET_14B_SHAPE_TEMP_REDBLUE.toml \
    --checkpoint ../checkpoints/20251005_20-28-40/epoch200 \
    --fps_values 3000 6000 10000  \
    --steps 30 \
    --frames 16 \
    --output_dir ../output/20251005_20-28-40_epoch200_temp_debug \
    ...
    --width 512 \
    --height 512 \
    > ../output/nohup_log/temp_20251005_20-28-40_epoch200_debug.out 2>&1 
