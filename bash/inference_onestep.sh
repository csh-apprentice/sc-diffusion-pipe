...
python test_fps_multiple_experiments_align_old.py \
    ...
    --steps 1 \
    --frames 16 \
    --output_dir ../output/onestep/20251008_06-48-34_epoch1000 \
    --prompt_folder /root/workspace/sc-diffusion-pipe/prompt_folder/bokeh_prompts/all_prompts  \
    --negative_prompt "色调艳丽，过曝，静态，细节模糊不清，字幕，风格，作品，画作，画面，静止，整体发灰，最差质量，低质量，JPEG压缩残留，丑陋的，残缺的，多余的手指，画得不好的手部，画得不好的脸部，畸形的，毁容的，形态畸形的肢体，手指融合，静止不动的画面，杂乱的背景，三条腿，背景人很多，倒着走." \
    --seed 42 \
    --port 29502 \
    ...
    --height 512 \
    --base_only \
    > ../output/nohup_log/bokeh_20251008_06-48-34_epoch1000_dog_50.out 2>&1 
...
#     --steps 1 \
#     --frames 16 \
#     --output_dir ../output/onestep/clean_99 \
#     --prompt_folder /root/workspace/sc-diffusion-pipe/prompt_folder/bokeh_prompts/all_prompts  \
#     --negative_prompt "色调艳丽，过曝，静态，细节模糊不清，字幕，风格，作品，画作，画面，静止，整体发灰，最差质量，低质量，JPEG压缩残留，丑陋的，残缺的，多余的手指，画得不好的手部，画得不好的脸部，畸形的，毁容的，形态畸形的肢体，手指融合，静止不动的画面，杂乱的背景，三条腿，背景人很多，倒着走." \
#     --seed 99 \
#     --port 29502 \
